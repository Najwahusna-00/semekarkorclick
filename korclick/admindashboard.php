...
<html>
	<head>
		<title>KORCLICK | Admin Profile</title>
	...
	#student tr:hover {background-color: #D6AAC2;}
	...
	<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
	  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
		...
		<a href="#about" class="w3-bar-item w3-button" style="width:25% !important">STUDENT INFO</a>
		<a href="#photos" class="w3-bar-item w3-button" style="width:25% !important">RESGISTRATION INFO</a>
		<a href="#contact" class="w3-bar-item w3-button" style="width:25% !important">SCEHDULE INFO</a>
   ...
   <br>
	...
	<center><h1 class="w3-text-black">STUDENT INFORMATION</h1>
...
<tr>
	...
	<td><a href="editStudent.php?id=<?php echo $data['id'];?>"style="text-decoration:none;">Edit</td>
	<td><a href="deletestudent.php?id=<?php echo $data['id'];?>" style="text-decoration:none;">Delete</td>
</tr>
<?php
}
?>
			...
			<br>
			<br>
			<a href="addstudent.php" target="_blank"><input type="submit" name="add" value="Add Record"></a>			
   ...
   <div class="form" id="photos">	  
	<center><h1 class="w3-text-black">CO-CURRICULUM REGISTRATION INFORMATION</h1>
	<hr style="width:200px" class="w3-opacity">
			<table border="1" id="student" >
				 <tr>
				  <th>ID</th>
				  ...
				  <th>Sport and Game</th>
				  <th colspan="2">Action</th>
				 </tr>
	<?php
	include "dbcon.php"; // Using database connection file here
	$records = mysqli_query($conn,"select * from registration"); // to fetch data from database
	while($data = mysqli_fetch_array($records))
	{
	?>
					<tr>
					 <td><?php echo $data ['id'];?></td>
					 <td><?php echo $data ['student_name'];?></td>
					 <td><?php echo $data ['uniform_body'];?></td>
					 <td><?php echo $data ['association_club'];?></td>
					 <td><?php echo $data ['sport_game'];?></td>
					 <td><a href="editreg.php?id=<?php echo $data ['id'];?>">Edit</td>
					 <td><a href="deletereg.php?id=<?php echo $data ['id'];?>">Delete</td>
					</tr>
					</tr>
	<?php
	}
	?>
			...
			<br>
			<br>
			<a href="addreg.php" target="_blank"><input type="submit" name="add" value="Add Record"></a>			
   <br>
   <br>
   <br>	
   <br>		
   ...
   <div class="form" id="contact">  
	<center><h1 class="w3-text-black">ACTIVITY SCHEDULE INFORMATION</h1>
	<hr style="width:200px" class="w3-opacity">
			<table border="1" id="student">
				 <tr>
				 <th>No.</th>
	...
	?>
					<tr>
					 ...
					 <td><a href="editactivityschedule.php?id=<?php echo $data ['id'];?>"style="text-decoration:none;">Edit</td>
					 <td><a href="deleteactivityschedule.php?id=<?php echo $data ['id'];?>"style="text-decoration:none;">Delete</td>
					</tr>
	<?php
	}
	?> 
			...
			<br>
			<br>
			<a href="addactivityschedule.php" target="_blank"><input type="submit" name="add" value="Add Record"></a>			
	<br>
   <br>
   <br>
   <br>		
