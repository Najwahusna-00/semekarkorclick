...
if(isset($_POST['submit_email']) && $_POST['email'])
{
  ...
  if(mysql_num_rows($select)==1)
  {
    ...
    $mail->SMTPAuth = true;                  
    // GMAIL username
    $mail->Username = "sarahnatasyan@gmail.com";
    // GMAIL password
    $mail->Password = "sarah12";
    $mail->SMTPSecure = "ssl";  
    // sets GMAIL as the SMTP server
    $mail->Host = "smtp.gmail.com";
    // set the SMTP port for the GMAIL server
    $mail->Port = "465";
    $mail->From='sarahnatasyan@gmail.com';
    $mail->FromName='sarah natasya binti nasri';
    $mail->AddAddress('sarah12', 'sarah');
